<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rmsreport.aspx.cs" Inherits="rmsreport" %>
...
<head id="Head1" runat="server">
    ...
    <link href="css/rmsreportstyle.css" rel="stylesheet" type="text/css" />
        ...
        function kotmod2pdf() {
            html2canvas(document.getElementById('tblitemsalereg'), {
                onrendered: function (canvas) {
                    ...
                    pdfMake.createPdf(docDefinition).download("kotmod.pdf");
                }
            });
        }
    </script>
    <script type="text/javascript">
        function billmod2pdf() {
            html2canvas(document.getElementById('tblitemsalereg'), {
                onrendered: function (canvas) {
                    var data = canvas.toDataURL();
                    var docDefinition = {
                    ...
                    pdfMake.createPdf(docDefinition).download("billmod.pdf");
                }
            });
        }
    </script>
...
<body data-spy="scroll" data-target=".navbar" data-offset="50">    
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><asp:Label ID="lblcustinfo" runat="server"  Text=""></asp:Label></a>
    </div>
    <div>
      <div class="collapse navbar-collapse" id="myNavbar">
        ...
        <li><asp:Label ID="lblvalidity" runat="server" Text="" Font-Size="Large" ForeColor="Red"></asp:Label></li>        
        </ul>        
        ...
        <div id="rptbusinesssummary" class="container-fluid">
            ...
            <br />
            <asp:Button ID="btnbusinesssummary" runat="server" Text="Generate" Width="90px" class="generatebutton generatebuttoncss"
                OnClick="btnbusinesssummary_Click" />
            &nbsp; &nbsp;       
        <input type="button" id="btnpdfbusinesssummary" value="PDF" class="pdfbutton pdfbuttoncss"
            width="90px" onclick="businesssummary2pdf()" />
            <br />
        ...
        <div id="rptbillregister" class="container-fluid">
            ...
            <br />
            <asp:Button ID="btnbillreg" runat="server" Text="Generate" Width="90px" class="generatebutton generatebuttoncss"
                OnClick="btnbillreg_Click" />
            &nbsp;
    ...
    <input type="button" id="btnpdfbillreg" value="PDF" class="pdfbutton pdfbuttoncss"
        ...
        <div id="rptbilldetail" class="container-fluid">
            ...
            <br />
            <asp:Button ID="btnbilldtl" runat="server" Text="Generate" Width="90px" class="generatebutton generatebuttoncss"
                OnClick="btnbilldtl_Click" />
            &nbsp; &nbsp;
    ...
    <input type="button" id="btnpdfbilldtl" value="PDF" class="pdfbutton pdfbuttoncss"
        ...
        <div id="rptkotmod" class="container-fluid">
            ...
            <br />
            <asp:Button ID="btnkotmod" runat="server" Text="Generate" Width="90px" class="generatebutton generatebuttoncss" OnClick="btnkotmod_Click" />
            &nbsp; &nbsp;
            <asp:Button ID="btnexcelkotmod" runat="server" class="excelbutton excelbuttoncss" Text="EXCEL" Width="90px" OnClick="kotmod2excel" />
            &nbsp; &nbsp;
            <input type="button" id="btnpdfkotmodreg" value="PDF" class="pdfbutton pdfbuttoncss" width="90px" onclick="kotmod2pdf()" />
            <br />
        ...
        <div id="rptbillmod" class="container-fluid">
            <h3>Bill Modified Detail</h3>
            <h4>FROM :</h4>
            <asp:TextBox ID="dtpbillmodsdt" class="form-control input-lg" runat="server"
                Width="200px" ReadOnly="true">
            </asp:TextBox>
            <h4>TO :</h4>
            <asp:TextBox ID="dtpbillmodedt" class="form-control input-lg" runat="server"
                Width="200px" ReadOnly="true">
            </asp:TextBox>
            <br />
            <asp:Button ID="btnbillmod" runat="server" Text="Generate" Width="90px" class="generatebutton generatebuttoncss"
                OnClick="btnbillmod_Click" />
            &nbsp; &nbsp;
            <asp:Button ID="btnexcelbillmod" runat="server" class="excelbutton excelbuttoncss"
                Text="EXCEL" Width="90px" OnClick="billmod2excel" />
            &nbsp; &nbsp;
    <input type="button" id="btnpdfbillmodreg" value="PDF" class="pdfbutton pdfbuttoncss"
        width="90px" onclick="billmod2pdf()" />
            <br />
